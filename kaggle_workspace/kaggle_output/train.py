...
# CONFIG
DATA_DIR = os.getenv('TRADING_DATA_DIR', 'dataset/ready/SPX500_USD') # Update to point to the merged directory
TOTAL_TIMESTEPS = 50_000_000 
TRAIN_SPLIT = 0.9 
N_ENVS = 8 # Increased parallelism to utilize more RAM/CPU
...
def main():
    ...
    # 5. Initialize Model
    # Optimize: Larger Batch Size (2048) to utilize RAM and improve throughput
    policy_kwargs = dict(net_arch=dict(pi=[128, 128], vf=[128, 128]))
    model = PPO("MlpPolicy", env_train, verbose=1, device="cpu", ent_coef=0.01, policy_kwargs=policy_kwargs, batch_size=2048) 
